...
==============================================================================*/
package io.jerryc05.hello_tf_lite.tflite
...
// contains the number of detected boxes
    ...
    override fun recognizeImage(bitmap: Bitmap?): List<Recognition?>? { // Log this method so that it can be analyzed with systrace.
