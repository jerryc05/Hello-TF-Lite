...
package io.jerryc05.hello_tf_lite.tracking;
...
public class MultiBoxTracker {
  ...
  final List<Pair<Float, RectF>> screenRects = new ArrayList<>();
  private final Logger logger = new Logger();
  private final List<Integer> availableColors = new ArrayList<>();
  private final List<TrackedRecognition> trackedObjects = new ArrayList<>();
  ...
  private void processResults(final List<Recognition> results) {
    final List<Pair<Float, Recognition>> rectsToTrack = new ArrayList<>();
