...
import io.jerryc05.hello_tf_lite.customview.AutoFitTextureView
...
class CameraConnectionFragment private constructor(
    ...
    private val stateCallback: CameraDevice.StateCallback = object : CameraDevice.StateCallback() {
        override fun onOpened(cd: CameraDevice) { // This method is called when the camera is opened.  We start camera preview here.
